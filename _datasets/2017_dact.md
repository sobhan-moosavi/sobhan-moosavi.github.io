...
excerpt: DACT contains two datasets of annotated car trajectories. Annotation is based on identifying significant driving patterns (e.g., making a turn, a hard-braking event, etc.) in a trajectory. This dataset is suitable for validation of trajectory segmentation approaches. 
date: 2017-05-14
---
