...
* __Version 3 (December 2020):__ In this version, we provide data which is collected from August 2016 to the end of December 2019 for the [Contiguous United States](https://en.wikipedia.org/wiki/Contiguous_United_States){:target="_blank"}. In this set, we have about 25.1 million traffic and 4.4 million weather event records. 
